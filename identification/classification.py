...
def main():
    ...
    parser.add_argument(
        "--dataset_path",
        type=str,
        default="C4Styli/slogans/val_advertise_slogans.json",
    )
    parser.add_argument(
        "--text_domain",
        type=str,
        default="slogans",
        choices=["titles", "slogans"],
    )
    parser.add_argument("--url_base", type=str, default="http://35.164.11.19:3887/v1")
    parser.add_argument("--model", type=str, default="SenseChat-5-Cantonese")
    parser.add_argument("--max_new_tokens", type=int, default=1024)
    parser.add_argument("--output_file", type=str, default="output/classification.json")
    parser.add_argument("--batch_size", type=int, default=1)
    parser.add_argument("--prompt_region", type=str, default="CN", choices=["CN", "HK"])
    parser.add_argument(
        "--zero", action="store_true", help="Use zero-shot classification"
    )
    ...
    for i in trange(
        0, len(data), args.batch_size, desc=f"Processing {args.text_domain} data"
    ):
